...
import { getCartTotal, removeItem, increaseItemQuantity, decreaseItemQuantity } from '../feature/cartSlice';
...
const CartPage = () => {
    ...
    return (
        <div>
            <section className="h-100 gradient-custom gradient-customc">
